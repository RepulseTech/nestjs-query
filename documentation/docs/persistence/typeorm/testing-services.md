...
import { getQueryServiceToken } from '@repulsetech/nestjs-query-core';
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        // Mock the SubTask QueryService using the `getQueryServiceToken` from @repulsetech/nestjs-query-core
        {
